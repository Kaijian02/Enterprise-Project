...
<body>
    <div class="container" style="margin-left:14%;">
        ...
        <p style="color:#7f8788">*Please leave a message for the customer if you wish to change the date or time.<br/>*If yes, please ask them to make a new request.</p>
        <h1 style="text-align: center;">Test Drive Records</h1>
                            ...
                            <tr>
                                ...
                                <td class="text">
                                    <p class="center-text"><button type="submit" name="send<?php echo $counter; ?>"
                                            class="btn-edit" style="display: inline-block; margin-top: 20px;">Send</button></p>
